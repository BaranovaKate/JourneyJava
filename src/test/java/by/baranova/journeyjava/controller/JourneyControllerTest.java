...
class JourneyControllerTest {
    ...
    void testFindJourneys_NoCountry() {
        ...
        when(journeyService.findJourneys()).thenReturn(Collections.singletonList(new JourneyDto()));
        ...
        verify(model, times(1)).addAttribute("journeys", Collections.singletonList(new JourneyDto()));
    }
